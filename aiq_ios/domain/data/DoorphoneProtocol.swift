...
class DoorphoneProtocol: NSObject {
  ...
  func fromByteCode(_ values: Array<UInt8>?) {
  ...
  func getSendProtocol(_ value: String) -> Array<UInt8>? {
    var sendArray: Array<UInt8> = []
    
    value.chunks(16).forEach {
      let splitArray = Array($0.utf8).padding(repeating: 0x00, inLength: 16)
